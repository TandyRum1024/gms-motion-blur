///particle3d_impulse_emit(size, life, x, y, z, vx, vy, vz)
...
// animation settings
_fx.texOff = global.textureList[@ ePTEX.IMPULSE, 1]; // texture index from atlas
_fx.animLen = global.textureList[@ ePTEX.IMPULSE, 2]; // sprite frames
