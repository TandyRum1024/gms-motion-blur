///vb_add_floor(vb, x, y, z, xsize, ysize, zsize, texindex, colour, alpha)
/*
...
vb_add_vtx(_vb, _x2, _y, _z2, _u2, _v1, _colour, _alpha); // tr
vb_add_vtx(_vb, _x, _y2, _z, _u1, _v2, _colour, _alpha); //bl
